...
const WorkerSettingsSection: React.FC<WorkerSettingsSectionProps> = ({ form, timeOptions }) => {
  return (
              ...
              <FormControl>
                <Select value={field.value} onValueChange={field.onChange}>
                  ...
                  <SelectContent className="bg-white z-50">
                    {timeOptions.filter(time => time >= '05:00' && time <= '10:00').map(time => (
            ...
            <FormItem>
              ...
              <FormControl>
                <Select value={field.value} onValueChange={field.onChange}>
                  ...
                  <SelectContent className="bg-white z-50">
                    {timeOptions.filter(time => time >= '14:00' && time <= '18:00').map(time => (
                      <SelectItem key={time} value={time}>
                        {time}
                      </SelectItem>
                    ))}
